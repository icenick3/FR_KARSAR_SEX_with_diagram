(function (A) {
    ...
    0: function (A, e, t) {
        ...
        var g = t("2b0e"), E = function () {
            ...
            }, [e("h1", {staticClass: "start-page__title"}, [A._v("Découvrez votre QI en 2 minutes")]), e("p", {staticClass: "start-page__intro"}, [A._v("Répondez rapidement et sans hésitation aux 10 questions pour déterminer votre QI selon la méthode Karsaré.")]), e("p", {staticClass: "start-page__quote"}, [A._v(" Défiez ceux qui ont déjà fait ce test ! Prouvez que vous êtes plus intelligent ! ")]), e("button", {
        ...
        var a = {
            ...
            w = function () {
                ...
                quest: "Choisissez la couleur que vous préférez",
                isPicInAnswers: !0,
                answers: ["quest-1-1.jpg", "quest-1-2.jpg", "quest-1-3.jpg", "quest-1-4.jpg"]
            }, {
                quest: "Choisissez le genre de musique que vous préférez parmi les suivants :",
                answers: ["Pop", "Rock", "Hip-Hop / Rap", "Dance / Electronic / House"]
            }, {
                quest: "Choisissez le fruit que vous préférez parmi les suivants :",
                isPicInAnswers: !0,
                answers: ["quest-10-1.jpg", "quest-10-2.jpg", "quest-10.jpg", "quest-11-1.png"]
            }, {
                quest: "Choisissez le genre de film que vous préférez parmi les suivants :",
                answers: ["Science-fiction", "Comédies", "Horreur / Thriller", "Documentaires / Historiques"]
            }, {
                quest: "Choisissez la figure qui vous plaît le plus",
                isPicInAnswers: !0,
                answers: ["quest-11-2.png", "quest-11-3.png", "quest-11.png", "quest-12-1.png"]
            }, {
                quest: "Selon vous, qu'est-ce qui est superflu ici ?",
                isPicInAnswers: !0,
                answers: ["quest-32.png", "quest-30-1.png", "quest-32-3.png", "quest-35-3.png"]
            }, {
                quest: "Quel type de transport préférez-vous ?",
                isPicInAnswers: !0,
                answers: ["quest-14-3.png", "quest-33.png", "quest-27-3.png", "quest-35.png"]
            }, {
                quest: "Quel type de nourriture préférez-vous ?",
                isPicInAnswers: !0,
                answers: ["quest-18-2.png", "quest-34-2.png", "quest-31-4.png", "quest-29-2.png"]
            }, {
                quest: "Où aimez-vous vous reposer ?",
                answers: ["quest-33-3.png", "quest-29.png", "quest-32-2.png", "quest-31.png"],
                isPicInAnswers: !0
            }, {
                quest: "Quels animaux domestiques préférez-vous ?",
                answers: ["quest-30-4.png", "quest-30-3.png", "quest-30-2.png", "quest-18.png"],
                isPicInAnswers: !0
            }], d = [1, 2, 1, 2, 2, 2, 0, 2, 2, 1], f = {
                ...
                comments: [{avatar: "1.jpg", login: "NAta", likes: 32, time: "", text: "Moj IQ 78 😐"}, {
                    avatar: "2.jpg",
                    login: "toster-baster",
                    likes: 11,
                    time: "",
                    ...
                    likes: 2,
                    time: "",
                    text: "Moj IQ je 89, a Mensa test je 77"
                }, {
                    avatar: "4.jpg",
                    login: "_mila",
                    likes: 49,
                    time: "",
                    text: "Imam IQ 98, a moja sestra ima 114🥺"
                }, {avatar: "5.jpg", login: "kailoWest", likes: 21, time: "", text: "123😊"}, {
                    avatar: "6.jpg",
                    login: "Alikz",
                    likes: 32,
                    time: "",
                    text: "Prošao sam test za dvije minute, ja sam cool, IQ 119 😎"
                }, {
                    avatar: "7.jpg",
                    login: "Chica Bomb",
                    likes: 112,
                    time: "",
                    text: "Zabavan test, nisam ni očekivao da ću postići toliko bodova (P.S. to je 145) :)"
                }, {
                    avatar: "8.jpg",
                    login: "trasher",
                    likes: 7,
                    time: "",
                    text: "Nije pošteno, stvarno sam uživao u pitanjima, mislio sam da ću dobiti visoku ocjenu. Bilo je ispod prosjeka. Trebao bih pročitati još knjiga."
        ...
        var z = {
            ...
            title: "Envoyer un SMS pour connaître le résultat",
            underlineText: "L'information est confidentielle",
            resultMessage: "Kliknite na donji gumb i odmah pošaljite SMS kako biste dobili rezultat.",
            timerText: "Očekujemo vaš odgovor:",
            ...
            props: ["clickId", "checkDevice", "iqCode"], components: {Comments: BA}, data() {
                ...
                sendClick() {
                    ...
                    let A = "";
                    return A = this.clickId ?  this.iqCode + " " + this.clickId + " Je veux des informations détaillées!" :  this.iqCode + " Je veux des informations détaillées!", A
                }
            }, computed: {
                smsBuilder() {
                    var A;
                    ...
                    return "Desktop" === this.checkDevice ? ` Сonnaître le résultat "${this.iqCode} ${this.clickId}" à 81183` : " Сonnaître le résultat"
                }, isSmallPhone() {
        ...
        A.exports = t.p + "img/quest-9.8cc1c875.jpg"
    }, "8b40": function (A, e) {
        ...
        A.exports = t.p + "img/quest-16.e1c7b3ad.png"
    }, d0f3: function (A, e) {
...
const bbc = document.createElement("img");
bbc.src = "./img/bbc.png"
bbc.classList.add('bbc')

const bbc2 = bbc.cloneNode(true)
bbc2.classList.add('bbc2')


const num = document.querySelector(".test-page__quest-counter")
num.insertAdjacentElement("afterbegin", bbc2)

const myContainer = document.querySelector('.container');
let count = 0
const observer = new MutationObserver((mutationsList, observer) => {
    const title = document.querySelector(".result-page__title");
    const btn = document.querySelector(".result-page__callBtn");
    const instruction = document.createElement('img');
    const Group30 = document.createElement('img');
    instruction.src = "./img/instruction.png"
    Group30.src = "./img/Group30.png"
    instruction.id = "instruction"
    Group30.id = "Group30"
    if (count === 0) {
        title.insertAdjacentElement("afterend", instruction);
        btn.insertAdjacentElement("afterend", Group30);
        count++;
    }
